...
const showProductInDom = (data: Notebook) => {
  ...
  document.body.innerHTML = `
    <div>
      ...
      <p>Fabricante: ${empresaFabricante.nome} fundada na ${
    empresaFabricante.pais
  } em ${empresaFabricante.fundacao}</p>
    <p>Montadora: ${empresaMontadora.nome} fundada na ${
    empresaMontadora.pais
  } em ${empresaMontadora.fundacao}</p>
    </div>
  `;
};
