...
const greaterThan10 = (data) => data.filter((age) => age > 10);
const smallerThan10 = (data) => data.filter((age) => age < 10);
console.log(greaterThan10(ages));
console.log(smallerThan10(ages));
const mixed = [10, "Carlos", 26, 52, 30, 42, "Paulo", "John", 64, 20, 10];
const filterNumbers = (data) => data.filter((item) => typeof item === "number");
const filterText = (data) => data.filter((item) => typeof item === "string");
